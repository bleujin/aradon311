...
public abstract class ClientResponse<T> extends Response {
	...
	/**
	 * Unmarshal the target entity from the response OutputStream. You must have type information set via <T> otherwise, this will not work.
	 * <p/>
	...
	/**
	 * Get the <a href="http://tools.ietf.org/html/draft-nottingham-http-link-header-10">link headers</a> of the response. All Link objects returned will automatically have the same ClientExecutor as the request.
	 * 
	 * @return non-null
	 */
