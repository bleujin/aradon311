...
public final class TypeConverter {
	...
	public static <T> T getType(final Class<T> targetType, final String source) {
		...
		try {
			...
			logger.warn("No valueOf() method available for {0}, trying constructor...", targetType.getSimpleName());
	...
	public static <T> T getTypeViaValueOfMethod(final String source, final Class<T> targetType) throws NoSuchMethodException {
	...
	private static <T> T getTypeViaStringConstructor(String source, Class<T> targetType) {
		...
		try {
			...
			String msg = new StringBuilder().append(targetType.getName()).append(" has no String constructor").toString();
