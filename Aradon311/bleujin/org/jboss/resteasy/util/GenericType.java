...
public class GenericType<T> {
	...
	/**
	 * Gets the raw type of the enclosed entity. Note that this is the raw type of the instance, not the raw type of the type parameter. I.e. in the example in the introduction, the raw type is {@code ArrayList} not {@code List}.
	 * 
	 * @return the raw type
	 */
	...
	/**
	 * Gets underlying {@code Type} instance. Note that this is derived from the type parameter, not the enclosed instance. I.e. in the example in the introduction, the type is {@code List<String>} not {@code ArrayList<String>}.
	 * 
	 * @return the type
	 */
