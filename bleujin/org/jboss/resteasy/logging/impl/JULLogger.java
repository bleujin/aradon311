...
public class JULLogger extends Logger {
	...
	public void trace(String message) {
		if (!delegate.isLoggable(java.util.logging.Level.FINEST))
			return;
	...
	public void trace(String message, Object... params) {
		if (!delegate.isLoggable(java.util.logging.Level.FINE))
			return;
	...
	public void info(String message) {
		if (!delegate.isLoggable(java.util.logging.Level.INFO))
			return;
	...
	public void warn(String message) {
		if (!delegate.isLoggable(java.util.logging.Level.WARNING))
			return;
	...
	public void error(String message) {
		if (!delegate.isLoggable(java.util.logging.Level.SEVERE))
			return;
