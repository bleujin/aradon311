...
public class GroupParameterParser {
	 ...
	 * 
	 * @param terminators
	 *            the array of terminating characters. Any of these characters when encountered signify the end of the token
	 * @return the token
	 */
	 ...
	 * 
	 * @param terminators
	 *            the array of terminating characters. Any of these characters when encountered outside the quotation marks signify the end of the token
	 * @return the token
	 */
	 ...
	 * 
	 * @param b
	 *            <tt>true</tt> if parameter names are to be converted to lower case when name/value pairs are parsed. <tt>false</tt> otherwise.
	 */
	 ...
	 * @return a map of name/value pairs
	 */
	public List<Map<String, String>> parse(final char[] chars, int offset, int length, char separator, char groupSeparator) {
		...
		while (hasChar()) {
			...
			if (hasChar() && (chars[pos] == '=')) {
				pos++; // skip '='
				paramValue = parseQuotedToken(new char[] { separator, groupSeparator });
			}
