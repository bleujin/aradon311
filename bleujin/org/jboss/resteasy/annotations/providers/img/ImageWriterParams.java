...
/**
 * An annotation that a resource class can use to pass parameters to the {@link IIOImageProvider}.
 * 
...
public @interface ImageWriterParams {
	...
	/**
	 * Specifies the compression mode for the output image. By default, it uses {@link javax.imageio.ImageWriteParam#MODE_COPY_FROM_METADATA}.
	 * 
	 * @return
	 */
