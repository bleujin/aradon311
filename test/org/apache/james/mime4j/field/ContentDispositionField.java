...
public class ContentDispositionField extends AbstractField {
	 ...
	 * @return <code>true</code> if the disposition type of this field matches, <code>false</code> otherwise.
	 */
	...
	/**
	 * Return <code>true</code> if the disposition type of this field is <i>inline</i>, <code>false</code> otherwise.
	 * 
	 * @return <code>true</code> if the disposition type of this field is <i>inline</i>, <code>false</code> otherwise.
	 */
	...
	/**
	 * Return <code>true</code> if the disposition type of this field is <i>attachment</i>, <code>false</code> otherwise.
	 * 
	 * @return <code>true</code> if the disposition type of this field is <i>attachment</i>, <code>false</code> otherwise.
	 */
	 ...
	 * 
	 * @return the <code>filename</code> parameter value or <code>null</code> if not set.
	 */
	...
	/**
	 * Gets the value of the <code>creation-date</code> parameter if set and valid.
	 * 
	 * @return the <code>creation-date</code> parameter value or <code>null</code> if not set or invalid.
	 */
	...
	/**
	 * Gets the value of the <code>modification-date</code> parameter if set and valid.
	 * 
	 * @return the <code>modification-date</code> parameter value or <code>null</code> if not set or invalid.
	 */
	...
	/**
	 * Gets the value of the <code>read-date</code> parameter if set and valid.
	 * 
	 * @return the <code>read-date</code> parameter value or <code>null</code> if not set or invalid.
	 */
	 ...
	 * 
	 * @return the <code>size</code> parameter value or <code>-1</code> if not set or invalid.
	 */
	public long getSize() {
