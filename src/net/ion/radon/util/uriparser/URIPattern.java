...
public class URIPattern extends URITemplate implements Matchable {
	 ...
	 * 
	 * <p>
	 * A template is matchable only if all its components are matchable tokens, that is the token implements the {@link Matchable} interface.
	 * 
	 * @param template
	 ...
	 * 
	 * Important note: the regular expression contain the same number of capturing groups as the number of token to facilitate the resolve process.
	 * 
