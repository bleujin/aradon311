...
package net.ion.radon.cload.compilers;
...
public final class JavaCompilerFactory {
     ...
     * 
     *  net.ion.radon.cload.compilers.SomeJavaCompiler
     *   
    ...
    public JavaCompiler createCompiler(final String pHint) {
        ...
        if (pHint.indexOf('.') < 0) {
            className = "net.ion.radon.cload.compilers." + ConversionUtils.toJavaCasing(pHint) + "JavaCompiler";
        } else {
            className = pHint;
        }
