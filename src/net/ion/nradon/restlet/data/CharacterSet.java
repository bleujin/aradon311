...
public final class CharacterSet extends Metadata {
	 ...
	 * 
	 * @see <a href="http://en.wikipedia.org/wiki/ISO_8859-10">Wikipedia page</a>
	 */
	 ...
	 * 
	 * @see <a href="http://en.wikipedia.org/wiki/Mac_OS_Roman">Wikipedia page</a>
	 */
	 ...
	 * 
	 * @see <a href="http://en.wikipedia.org/wiki/Windows-1252">Wikipedia page</a>
	 * 
	 */
	...
	/**
	 * Handles mapping between Java character set names and IANA preferred name. For example, "MACROMAN" is not an official IANA name and "ISO-8859-6" is preferred over "arabic".
	 * 
	 * @param name
