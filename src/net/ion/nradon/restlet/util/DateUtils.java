...
public final class DateUtils {
	...
	public static Date parse(String date, List<String> formats) {
		...
		for (int i = 0; (result == null) && (i < formatsSize); i++) {
			...
			// [ifdef gwt]
			/*
			 * GWT difference: DateTimeFormat parser is not passed a Locale in the same way as SimpleDateFormat. It derives locale information from the GWT application's locale.
			 * 
			 * Default timezone is GMT unless specified via a GMT:hhmm, GMT:+hhmm, or GMT:-hhmm string.
			 */
			// [enddef]
			// [ifdef gwt] uncomment
